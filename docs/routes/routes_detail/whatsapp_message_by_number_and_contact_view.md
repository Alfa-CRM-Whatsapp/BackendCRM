...
- Route: /api/messages/number/<int:number_id>/contact/<str:wa_id>/
- View: WhatsappMessageByNumberAndContactView
...
### GET
- Lista Por Numero E Contato: `GET /api/messages/number/{number_id}/contact/{wa_id}/`
- Query Params:
- `category`: Categoria.
...
- `day`: Dia.
- Exemplo:
`GET /api/messages/number/1/contact/5511999999999/?text=suporte`
